...
ORDER_ACCESS_SECRET ORIGIN_SHARED_SECRET PRICE_QUOTE_SECRET SHIPPING_QUOTE_SECRET TAX_QUOTE_SECRET
ARTWORK_STORAGE_ACCESS_KEY_ID ARTWORK_STORAGE_SECRET_ACCESS_KEY
