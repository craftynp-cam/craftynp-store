...
Open the pull request against `dev`. Any merge method is allowed — squash is
fine and usually preferable for keeping `dev` history readable.
...
| `protected-branches` | `dev` | PR required; merge, squash, or rebase | repo admin |
